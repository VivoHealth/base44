...
import {
  ...
  Calendar, CreditCard, Wallet, User, Settings, Heart, LogOut, Menu, X, Bell,
} from "lucide-react";

const navItems = [
  { label: "Apžvalga", path: "/gydytojas", icon: LayoutDashboard },
  { label: "Pacientai", path: "/gydytojas/pacientai", icon: Users },
  { label: "Peržiūros", path: "/gydytojas/perziuros", icon: ClipboardCheck },
  { label: "Įspėjimai", path: "/gydytojas/ispėjimai", icon: AlertTriangle },
  { label: "Žinutės", path: "/gydytojas/zinutes", icon: MessageSquare },
  { label: "Paskyros", path: "/gydytojas/paskyros", icon: Calendar },
  { label: "Planai", path: "/gydytojas/planai", icon: CreditCard },
  { label: "Pajamos", path: "/gydytojas/pajamos", icon: Wallet },
  { label: "Profilis", path: "/gydytojas/profilis", icon: User },
  { label: "Nustatymai", path: "/gydytojas/nustatymai", icon: Settings },
];
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 mb-4">
        <div className="p-3 rounded-2xl bg-emerald-50/50 border border-emerald-100">
          ...
          <p className="text-xs text-emerald-600">Patvirtinta • Šeimos medicina</p>
        </div>
      </div>
