...
import { medications } from "@/lib/demoDataEn";

export default function MedicationsEn() {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">Your active medications and reminders</p>
        </div>
        <Button className="bg-sky-600 hover:bg-sky-700"><Plus className="w-4 h-4 mr-1" /> Add medication</Button>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <Card className="p-4 rounded-2xl border-slate-100">
          <p className="text-xs text-slate-500">Missed doses (month)</p>
          ...
          <Card key={med.id} className="p-5 rounded-2xl border-slate-100">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {med.active ? (
                    ...
                    <Badge className="bg-slate-50 text-slate-500 border-slate-200">Discontinued</Badge>
                  )}
                </div>
                ...
                <div className="flex flex-wrap gap-4 mt-3 text-xs text-slate-500">
                  <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> Reminder: {med.reminder}</span>
              ...
              <Button
                ...
                size="sm"
              >
                {med.takenToday ? <><Check className="w-4 h-4 mr-1" /> Taken</> : "Mark as taken"}
              </Button>
            </div>
          </Card>
        ))}
