...
export default function AIAssistant() {
  const [messages, setMessages] = useState([
    {
      role: "ai",
      content: "Sveiki, aš esu jūsų HealthPilot AI asistentas. Galiu padėti tvarkyti ir paaiškinti jūsų sveikatos informaciją, sekti pokyčius ir paruošti santraukas jūsų gydytojui. Negaliu diagnozuoti ligų ar pakeisti medicinos specialisto.",
    },
  ]);
